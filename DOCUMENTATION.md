 ...
 * **Apply Thumb Override:** Determines whether to apply the given thumb override.
 * **Thumb Override:** The axis override for the thumb on an Interact Touch event.
 * **Apply Index Override:** Determines whether to apply the given index finger override.
 * **Index Override:** The axis override for the index finger on an Interact Touch event.
 * **Apply Middle Override:** Determines whether to apply the given middle finger override.
 * **Middle Override:** The axis override for the middle finger on an Interact Touch event.
 * **Apply Ring Override:** Determines whether to apply the given ring finger override.
 * **Ring Override:** The axis override for the ring finger on an Interact Touch event.
 * **Apply Pinky Override:** Determines whether to apply the given pinky finger override.
 * **Pinky Override:** The axis override for the pinky finger on an Interact Touch event.
 * **Auto Detect Controller:** Determines whether the Finger and State settings are auto set based on the connected controller type.
 * **Mirror Model:** If this is checked then the Hand will be mirrored, tick this if the model is used for the left hand controller.
